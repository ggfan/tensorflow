...
#include "common/platform/platform.h"  // To pick up PLATFORM_define

#if defined(PLATFORM_GOOGLE) || defined(PLATFORM_GOOGLE_ANDROID) || \
    defined(GOOGLE_LOGGING)
#include "common/platform/google/build_config/logging.h"
#else
#include "common/platform/default/logging.h"
#endif
