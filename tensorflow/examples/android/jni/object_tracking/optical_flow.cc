...
bool OpticalFlow::FindFlowAtPoint_ESM(const Image<uint8_t>& img_I,
                                      const Image<uint8_t>& img_J,
                                      const Image<int32_t>& I_x,
                                      const Image<int32_t>& I_y,
                                      const Image<int32_t>& J_x,
                                      const Image<int32_t>& J_y,
                                      const float p_x,
                                      const float p_y,
                                      float* out_g_x,
                                      float* out_g_y) {
    ...
    for (int y = 0; y < patch_size; ++y, templ_row += patch_size,
      ...
      for (int x = 0; x < patch_size; ++x) {
        ...
        int32_t diff = static_cast<int32_t>(extract_row[x]) -
                     static_cast<int32_t>(templ_row[x]) -
                     bright_offset;
